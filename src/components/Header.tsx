...
export default function Header() {
  ...
  const navColor   = isLight ? "text-black/60 hover:text-black" : "text-white/60 hover:text-white";
  const logoColor  = isLight ? "text-black"   : "text-white";
  const dotColor   = isLight ? "text-black/40" : "text-white/40";
      ...
      <div className="flex items-center justify-between px-5 md:px-12 h-[52px] max-w-[1680px] mx-auto">
        ...
        >
          ...
          <div className="flex items-baseline gap-0.5">
            <span
              className={`text-[13px] font-semibold tracking-tight transition-colors duration-500 ${logoColor}`}
              style={{ fontFamily: "var(--font-inter)" }}
            >
              Aya Karou
            </span>
            <span
              className={`text-[13px] font-normal transition-colors duration-500 ${dotColor}`}
              style={{ fontFamily: "var(--font-inter)" }}
            >
              .dev
            </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            aria-label="GitHub"
            className={`flex items-center justify-center w-7 h-7 rounded-full transition-all duration-300 ${isLight ? "text-black/60 hover:text-black hover:bg-black/8" : "text-white/60 hover:text-white hover:bg-white/8"}`}
          >
